...
const API_URL = "https://pannfirhkfdgthaagou27kyu4a.appsync-api.eu-west-2.amazonaws.com/graphql"
...
const createAppSyncGraphQLOperationAdapter = () => ({
  applyMiddleware: async (options, next) => {
      ...
      options.data = JSON.stringify({
          query: typeof options.query === 'string' ? options.query : graphqlPrinter(options.query),
